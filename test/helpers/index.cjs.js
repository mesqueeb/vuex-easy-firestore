 ...
 * @returns {*}
 */
function createFirestores (easyFirestoreModule, _a) {
    var _b = _a === void 0 ? {
        logging: false,
...
var easyFirestores = createFirestores([pokemonBox, mainCharacter, testPathVar, testMutations1, testMutations2], { logging: false, FirebaseDependency: Firebase });
var storeObj = {
