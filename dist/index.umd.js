(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('vuex-easy-access'), require('is-what'), require('firebase/app'), require('firebase/firestore'), require('firebase/auth')) :
	typeof define === 'function' && define.amd ? define(['vuex-easy-access', 'is-what', 'firebase/app', 'firebase/firestore', 'firebase/auth'], factory) :
	(global.VuexEasyFirestore = factory(global.vuexEasyAccess,global.isWhat,global.Firebase));
}(this, (function (vuexEasyAccess,isWhat,Firebase) { 'use strict';
